...
FUNCTION_NAME="sync-full-work-item-details-to-bq" # Updated Function Name
SOURCE_DIR="./work_item_details_pipeline/work_item_details_sync_full" # Updated Source Dir
ENTRY_POINT="sync_full_work_item_details" # Updated Entry Point
